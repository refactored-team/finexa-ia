...
from pipeline.domain.models import FinexaCategory
...
class RedisCache:
    ...
    def __init__(self, client: "redis.Redis", ttl_seconds: int | None = None, prefix: str = "finexa:merchant:"):
        self._client = client
        self._ttl = ttl_seconds if ttl_seconds is not None else settings.cache_ttl_seconds
        self._prefix = prefix
...
default_cache: ClassificationCache = InMemoryCache()
