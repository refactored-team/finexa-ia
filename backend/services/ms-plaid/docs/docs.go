...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/users/{userId}/plaid-item/status": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/finexa-ia_ms-plaid_internal_models.PlaidLinkStatusOKResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/users/{userId}/plaid/link-token": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Overrides opcionales (webhook, redirect)",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/finexa-ia_ms-plaid_internal_models.CreateLinkTokenBody"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "finexa-ia_ms-plaid_internal_models.LinkTokenResponse": {
            "type": "object",
            "properties": {
                "expiration": {
                    "type": "string"
        ...
        "finexa-ia_ms-plaid_internal_models.PlaidItemResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "finexa-ia_ms-plaid_internal_models.PlaidLinkStatusData": {
            "type": "object",
            "properties": {
                "linked": {
                    "type": "boolean"
        ...
        "finexa-ia_ms-plaid_internal_models.PlaidLinkStatusOKResult": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/finexa-ia_ms-plaid_internal_models.PlaidLinkStatusData"
                },
                "ok": {
                    "type": "boolean"
                }
